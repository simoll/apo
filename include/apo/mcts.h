...
struct MonteCarloOptimizer {
  ...
  void greedyOptimization(ProgramVec & oBestVec, ProgramVec & oStopVec, ProgramVec & progVec, IntVec & oReqSteps, const IntVec & maxDistVec, int startId, int endId, std::string towerName);
